...
| Device Compliance Action    | `device_compliance_action_item` | `Rule`                     |
...
| Device Detected Application | `detected_apps`                 | `Application`              |
...
| `device_compliance_action_item` | **MITIGATES**         | `device_statuses`               |
...
| `microsoft_365_user`            | **HAS**               | `managed_device`                |
